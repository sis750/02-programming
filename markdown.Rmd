...
Before we get started: You need to install `rmarkdown` and `tintyex` to make this work.^[Also check out the `setup` code chunk. Include it first, and be sure to specify `include=FALSE`.]    


## Literate programming with R Markdown
This is an R Markdown document. Markdown is a simple formatting syntax for authoring reports, slide decks, websites, and more. Of special note fur us, Markdown allows you to integrate R code into the body text of your work. The combination of coding and typesetting is often referred to as "literate programming."

### Markdown resources  
There are a number of excellent, stand-alone resources on Markdown. Yihui Xie's [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/)  (Xie et al. 2023), for example, covers installation, documents, slide presentations, and much more. 

<!-- This is a comment in markdown -->
<!-- shift + command/cntl + c to comment -->
